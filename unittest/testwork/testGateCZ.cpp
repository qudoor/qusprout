...
/*
测试结果：
Cmd(gate=CZ, targets=[1], controls=[0], rotation=[], desc=cz q[0] q[1], inverse=0)
test CZ inverse state:Zero 初始振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[0, 0],] 应用门后的振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[-0, -0],] 逆操作后的振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[0, 0],] 
Cmd(gate=CZ, targets=[1], controls=[0], rotation=[], desc=cz q[0] q[1], inverse=0)
test CZ inverse state:Plus 初始振幅:[[0.707106781187, 0],[0, 0],[0.707106781187, 0],[0, 0],] 应用门后的振幅:[[0.707106781187, 0],[0, 0],[0.707106781187, 0],[-0, -0],] 逆操作后的振幅:[[0.707106781187, 0],[0, 0],[0.707106781187, 0],[0, 0],] 
Cmd(gate=CZ, targets=[1], controls=[0], rotation=[], desc=cz q[0] q[1], inverse=0)
test CZ inverse state:Classical 初始振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[0, 0],] 应用门后的振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[-0, -0],] 逆操作后的振幅:[[0.707106781187, 0],[0.707106781187, 0],[0, 0],[0, 0],] 
测试结论：通过
*/
bool CTestGateCZ::TestInv(const InitState::type state)
{
    ...
    osprint << "test CZ inverse state:" << to_string(state) << " 初始振幅:[";
