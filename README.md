...
* QuSprout 支持多个量子线路的任务管理、MPI多进程并行计算。
* QuSprout 使用 C++ 作为宿主语言，当前支持Kylin，Ubuntu，CentOS操作系统，支持在x86，arm64体系上编译部署，建议使用KylinV10，Ubuntu22.04，CentOS7.9，后续会增加对MacOS系统支持。
