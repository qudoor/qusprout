...
GetTaskInfoReq::GetTaskInfoReq(const GetTaskInfoReq& other263) {
  id = other263.id;
}
GetTaskInfoReq& GetTaskInfoReq::operator=(const GetTaskInfoReq& other264) {
  id = other264.id;
  return *this;
}
...
GetTaskInfoResp::GetTaskInfoResp(const GetTaskInfoResp& other265) {
  base = other265.base;
  state = other265.state;
}
GetTaskInfoResp& GetTaskInfoResp::operator=(const GetTaskInfoResp& other266) {
  base = other266.base;
  state = other266.state;
  return *this;
}
...
GetRandomCardInfoReq::GetRandomCardInfoReq(const GetRandomCardInfoReq& other267) noexcept {
  (void) other267;
}
GetRandomCardInfoReq& GetRandomCardInfoReq::operator=(const GetRandomCardInfoReq& other268) noexcept {
  (void) other268;
  return *this;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->cards.resize(_size269);
            uint32_t _i273;
            for (_i273 = 0; _i273 < _size269; ++_i273)
            {
              xfer += this->cards[_i273].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_cards = true;
...
uint32_t GetRandomCardInfoResp::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("cards", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    std::vector<RandomCardInfo> ::const_iterator _iter274;
    for (_iter274 = this->cards.begin(); _iter274 != this->cards.end(); ++_iter274)
    {
...
GetRandomCardInfoResp::GetRandomCardInfoResp(const GetRandomCardInfoResp& other275) {
  base = other275.base;
  count = other275.count;
  driver_version = other275.driver_version;
  library_version = other275.library_version;
  cards = other275.cards;
}
GetRandomCardInfoResp& GetRandomCardInfoResp::operator=(const GetRandomCardInfoResp& other276) {
  base = other276.base;
  count = other276.count;
  driver_version = other276.driver_version;
  library_version = other276.library_version;
  cards = other276.cards;
  return *this;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              RandomCardStateType::type _key282;
              int32_t ecast284;
              xfer += iprot->readI32(ecast284);
              _key282 = static_cast<RandomCardStateType::type>(ecast284);
              int32_t& _val283 = this->states[_key282];
...
uint32_t RandomCardInfo::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("states", ::apache::thrift::protocol::T_MAP, 5);
  {
    ...
    std::map<RandomCardStateType::type, int32_t> ::const_iterator _iter285;
    for (_iter285 = this->states.begin(); _iter285 != this->states.end(); ++_iter285)
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter285->first));
      xfer += oprot->writeI32(_iter285->second);
    }
...
RandomCardInfo::RandomCardInfo(const RandomCardInfo& other286) {
  device_index = other286.device_index;
  mode = other286.mode;
  ld_temp = other286.ld_temp;
  bd_temp = other286.bd_temp;
  states = other286.states;
}
RandomCardInfo& RandomCardInfo::operator=(const RandomCardInfo& other287) {
  device_index = other287.device_index;
  mode = other287.mode;
  ld_temp = other287.ld_temp;
  bd_temp = other287.bd_temp;
  states = other287.states;
  return *this;
}
...
SetRandomCardReq::SetRandomCardReq(const SetRandomCardReq& other288) noexcept {
  device_index = other288.device_index;
  mode = other288.mode;
  reset = other288.reset;
  __isset = other288.__isset;
}
SetRandomCardReq& SetRandomCardReq::operator=(const SetRandomCardReq& other289) noexcept {
  device_index = other289.device_index;
  mode = other289.mode;
  reset = other289.reset;
...
SetRandomCardResp::SetRandomCardResp(const SetRandomCardResp& other290) {
  base = other290.base;
}
SetRandomCardResp& SetRandomCardResp::operator=(const SetRandomCardResp& other291) {
  base = other291.base;
  return *this;
}
...
GetRandomReq::GetRandomReq(const GetRandomReq& other292) noexcept {
  random_length = other292.random_length;
  random_num = other292.random_num;
  device_index = other292.device_index;
  __isset = other292.__isset;
}
GetRandomReq& GetRandomReq::operator=(const GetRandomReq& other293) noexcept {
  random_length = other293.random_length;
  random_num = other293.random_num;
  device_index = other293.device_index;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->randoms.resize(_size294);
            uint32_t _i298;
            for (_i298 = 0; _i298 < _size294; ++_i298)
            {
              xfer += iprot->readBinary(this->randoms[_i298]);
            }
            xfer += iprot->readListEnd();
          }
          isset_randoms = true;
...
uint32_t GetRandomResp::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("randoms", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter299 = this->randoms.begin(); _iter299 != this->randoms.end(); ++_iter299)
    {
...
GetRandomResp::GetRandomResp(const GetRandomResp& other300) {
  base = other300.base;
  randoms = other300.randoms;
}
GetRandomResp& GetRandomResp::operator=(const GetRandomResp& other301) {
  base = other301.base;
  randoms = other301.randoms;
  return *this;
}
