#ifndef __H__SLAVESERVERHANDLE__H__
#define __H__SLAVESERVERHANDLE__H__

#include "interface/SlaveServer.h"
#include "interface/qusproutdata_types.h"
#include "comm/Base.h"

class CSlaveServerHandler : virtual public SlaveServerIf, public CBase 
{
public:
    CSlaveServerHandler();
    virtual ~CSlaveServerHandler();
